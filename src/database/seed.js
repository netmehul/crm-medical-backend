...
const seed = async () => {
  try {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      db.run(
        ...
        [
          ...
          aptDate.toISOString(), appointmentTypes[i],
    ...
    console.log('   ─────────────────────────────────────────────');
    console.log('   Platform Admin:  admin@medicrm.com / password123');
    console.log('   ─────────────────────────────────────────────');
    console.log('   Owner (2 branches → branch-select):');
    console.log('     owner@demo.com / password123');
    console.log('   Doctor (1 branch → direct to dashboard):');
    console.log('     doctor@demo.com / password123');
    console.log('   Receptionist (1 branch → direct to dashboard):');
    console.log('     receptionist@demo.com / password123');
    console.log('   ─────────────────────────────────────────────');
    console.log('   Free plan owner: cityclinic@demo.com / password123');
    console.log('');
