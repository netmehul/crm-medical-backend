...
router.get('/supplier-report',     asyncHandler((req, res) => InventoryController.getSupplierReport(req, res)));
router.get('/payment-summary',     asyncHandler((req, res) => InventoryController.getPaymentSummary(req, res)));
...
router.put('/transactions/:id/pay', asyncHandler((req, res) => InventoryController.markAsPaid(req, res)));
